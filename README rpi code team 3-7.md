example.py is the python code responsible for the operation of the lock mechanism and the weight sensors which are used to tell the user if an item is available or not.
